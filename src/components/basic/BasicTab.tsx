            ...
            <Box mb={1}>
                <Card className={styles.instructionCard}>
                    <CardContent>
                        ...
                        <Typography variant="body2">This is a basic tool to explore the general idea of GPT-4. GPT-4 will try to continue text you wrote in the prompt field and will display the result in the field below.</Typography>
                        <Box mt={1}>
                            <Button
                                variant="contained"
                                size="large"
